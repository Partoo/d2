guard :concat, :type => "css", :files => %w[style timeline-component main-responsive], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[common], :input_dir => "public/js", :output => "public/js/scripts.min"
