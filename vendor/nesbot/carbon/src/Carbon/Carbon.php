...
class Carbon extends DateTime
{
   ...
   */
   ...
   {
      return $this->modify(intval($value) . ' 年');
   }
   ...
   {
      return $this->modify(intval($value) . ' 月');
   }
   ...
   {
      return $this->modify(intval($value) . ' 天');
   }
   ...
   {
      return $this->modify(intval($value) . ' 工作日');
   }
   ...
   {
      return $this->modify(intval($value) . ' 周');
   }
   ...
   {
      return $this->modify(intval($value) . ' 小时');
   }
   ...
   {
      return $this->modify(intval($value) . ' 分钟');
   }
   ...
   {
      return $this->modify(intval($value) . ' 秒');
   }
