...
class SentryServiceProvider extends ServiceProvider {
	...
	/**
	 * Register the unit provider used by Sentry.
	 *
	 * @return void
	 */
	protected function registerUnitProvider()
	{
		$this->app['sentry.unit'] = $this->app->share(function($app)
		{
			$model = $app['config']['cartalyst/sentry::units.model'];

			return new UnitProvider($model);
		});
	}
