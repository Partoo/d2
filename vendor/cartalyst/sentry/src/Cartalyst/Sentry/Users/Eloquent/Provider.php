...
class Provider implements ProviderInterface {
	...
	public function findByCredentials(array $credentials)
	{
		...
		{
			throw new \InvalidArgumentException("登录方式不支持");
		}
	...
	public function findByActivationCode($code)
	{
		if ( ! $code)
		{
			throw new \InvalidArgumentException("无法发送激活码");
		}
	...
	public function findAllInUnit(UnitInterface $unit)
	{
		return $unit->users()->get();
	}
