...
class User extends Model implements UserInterface {
	...
	/**
	 * Returns an array of units which the given
	 * user belongs to.
	 *
	 * @return array
	 */
	...
	/**
	 * Adds the user to the given unit.
	 *
	...
	/**
	 * Removes the user from the given unit.
	 *
	 * @param \Cartalyst\Sentry\Units\UnitInterface  $unit
	 * @return bool
	 */
	...
	/**
	 * See if the user is in the given unit.
	 *
	 * @param \Cartalyst\Sentry\Units\UnitInterface  $unit
	 * @return bool
	 */
	public function inUnit(UnitInterface $unit)
	{
		foreach ($this->getUnits() as $_unit)
		{
			if ($_unit->getId() == $unit->getId())
			{
				return true;
			}
		}
	...
	/**
	 * Returns the relationship between users and units.
	 *
	 * @return Illuminate\Database\Eloquent\Relations\BelongsToMany
	 */
	public function units()
	{
		return $this->belongsToMany('Cartalyst\Sentry\Units\Eloquent\Unit', 'users_units');
	}
	/**
