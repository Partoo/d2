        ...
        <div class="widget blue">
            ...
            <div class="widget-body">
                    ...
                    <div class="span8">
                        <div class="control-group {{ $errors->has('subject') ? 'error' : '' }}">
                            ...
                            <div class="controls controls-row">
                                <input type="text" class="input-block-level" placeholder="请输入公文名称" name="subject" value="{{$data->subject}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select class="span12" name="category">
                                    ...
                                    <option value="{{$item->id}}" @if($data->category==$item->id) selected @endif>{{$item->category}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="control-group {{ $errors->has('docnumber') ? 'error' : '' }}">
                            ...
                            <div class="controls controls-row">
                                <input type="text" class="input-block-level" placeholder="请输入发文字号" name="docnumber" value="@if( isset($input['docnumber']) ){{ $input['docnumber'] }}@endif {{$data->docnumber}}" > {{$errors->first('docnumber','<span class="help-inline">:message</span>')}}
                            </div>
                        </div>
                    </div>
                    <div class="span6">
                        <div class="control-group {{ $errors->has('tags') ? 'error' : '' }}">
                            ...
                            <div class="controls controls-row">
                                <input type="text"  class="input-block-level" placeholder="多个主题词用空格分隔" name="tags" value="{{$tags}}"> {{$errors->first('tags','<span class="help-inline">:message</span>')}}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span4">
                        <div class="control-group {{ $errors->has('content') ? 'error' : '' }}">
                            ...
                            <div class="controls controls-row">
                                <textarea  name="content" class="span12" placeholder="如果有公文附件，可以只填写概要或不填">{{$data->content}}</textarea>{{$errors->first('content','<span class="help-inline">:message</span>')}}
                            </div>
                        </div>
                    </div>
                    <div class="span4">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select class="span12" name="priority">
                                    ...
                                    <option <?php if ($key==$data->priority){echo 'selected=\"selected\"';}?> value="{{$val}}">{{$val}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select class="span12" name="seclevel">
                                    ...
                                    <option <?php if ($key==$data->seclevel){echo 'selected=\"selected\"';}?> value="{{$val}}">{{$val}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        <div class="control-group">
                            <label class="control-label"><i class="icon-code"></i>  发送信息</label>
                            <div class="controls controls-row">
                                <textarea class="message span12" name="message" rows="1"  placeholder="新公文请求批示">新公文请求批示</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="span3">
