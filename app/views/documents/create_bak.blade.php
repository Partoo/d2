        ...
        <div class="widget blue">
            ...
            <div class="widget-body">
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="control-group">
                            <label class="control-label"><i class="icon-calendar"></i>  处理截止日期</label>
                            <div class="controls">
                                <input name="expireDate" class="input-block-level" type="text" id="expireDate" data-date-format="yyyy-mm-dd">
                            </div>
                        </div>
                    ...
                    <div class="span6">
                        <div class="control-group">
                            <label class="control-label"><i class="icon-random"></i>  是否设为持续跟踪？</label>
                            <div class="controls">
                                <input name="expireDate" class="input-block-level" type="text" id="expireDate" data-date-format="yyyy-mm-dd">
                            </div>
                        </div>
