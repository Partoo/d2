 ...
 <div class="span12">
  <div class="widget blue">
    <div class="widget-title">
      <h4><i class="icon-reorder"></i> 管理群组</h4>
      <span class="tools">
   ...
   <div class="widget-body">
    <div>
      <ul class="nav nav-tabs">
        ...
        <li><a data-toggle="tab" href="#users">群组用户</a></li>
      </ul>
      ...
      <div class="tab-content ">
        <div id="general" class="tab-pane  active">
          ...
          <div class="control-group offset3 {{ $errors->has('name') ? 'error' : '' }}">
            ...
            <div class="controls"><input type="text" name="name" value="{{$group->name}}">
        ...
        <div class="control-group offset2">
          <div class="controls">
            ...
            <button type="submit" class="btn-large btn-success"><i class="icon-edit"></i>  更改群组</button>
          </div>
        </div>
      </div>
      <!-- Form Actions -->
...
$(document).ready(function() {
  ...
  $('#dataTable').dataTable({
    "bProcessing": true,
    "bServerSide": true,
    "sAjaxSource": "{{route('group_show',$group->id)}}",
    "oLanguage": {
