  ...
  {{Form::open(array('class'=>'form-horizontal'))}}
      ...
      <div id="category" class="tab-pane active">
        ...
        <div class="control-group" id="categoryEditor">
            ...
            <a href="#" style="margin-bottom:5px;" class="btn btn-info edit" data-type="text" data-name="category" data-pk="{{$cat->id}}" >{{$cat->category}}</a><a href="{{route('delete/category', $cat->id)}}"  class="btn  btn-info remove-btn" style="margin-bottom:5px;display:none"><span><i class="icon-remove"></i></span></a>
            @endforeach
