 ...
 <div class="span12">
   <div class="widget blue">
     <div class="widget-title">
       <h4><i class="icon-sitemap"></i>  发文单位设置</h4>
...
<div class="widget-body">
  ...
  {{Form::open(array('class'=>'form-horizontal'))}}
        ...
        <div class="control-group">
            ...
            <a href="#" style="margin-bottom:5px;" class="btn btn-info edit" data-type="text" data-name="unit" data-pk="{{$val->id}}" >{{$val->unit}}</a><a href="{{route('param/delete/unit', $val->id)}}"  class="btn  btn-info remove-btn" style="margin-bottom:5px;display:none"><span><i class="icon-remove"></i></span></a>
            @endforeach
            <a href="#" style="margin-bottom:5px;" class="btn btn-success createbox editable editable-click editable-empty" data-value='' data-type="text" data-name="unit" data-original-title="请输入内容"><i class="icon-plus"></i>  新建</a><a class="btn btn-success save-btn" style="margin-bottom:5px;display:none"><span><i class="icon-save"></i></span></a>
        </div>
        <div>
